...
import {Alert, AppState, AppStateStatus, Platform, StatusBar} from 'react-native';
...
import {checkAndUpdateApp} from "./service/InApp/InAppUpdate";
...
const AppFirebaseAuth = () => {
  useEffect(() => {
    GoogleSignin.configure({
      webClientId:
        '116526348710-c2tre25rv98n6l4ebb5tcitunapcc51n.apps.googleusercontent.com',
      offlineAccess: true,
    });
  }, []);
};
